...
// The class definition in EE_Analysis.h has been generated automatically
...
//
// Root > T->Process("EE_Analysis.C")
// Root > T->Process("EE_Analysis.C","some options")
// Root > T->Process("EE_Analysis.C+")
//
...
void EE_Analysis::Terminate()
{
  ...
  TFile *f = new TFile("EE_Analysis.root","RECREATE");
