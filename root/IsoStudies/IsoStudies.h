...
class IsoStudies : public TSelector {
public :
...
/*    Plotter h_diMassZ4,h_diMassZ5,h_diMassZ6,h_diMassZ7,h_diMassZ8; */
  ...
  TString dataset;
   ...
   ////////
   ClassDef(IsoStudies,0);
};

#endif

#ifdef IsoStudies_cxx
void IsoStudies::Init(TTree *tree)
{
...
void IsoStudies::GetAllBranches(Long64_t & entry)
{
