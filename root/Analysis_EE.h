...
#ifndef Analysis_EE_h
#define Analysis_EE_h
...
class Analysis_EE : public TSelector {
public :
   ...
   vector<int>   *lepQ;
   vector<int>     *lepType;
   vector<float>   *lepPfIso;
   vector<float>   *lepCombIso;
   vector<float>   *jetPt;
   vector<float>   *jetEta;
   vector<float>   *jetPhi;
   ...
   Int_t           jetMulti;
   Int_t           jetMultiJesUp;
   Int_t           jetMultiJesDown;
   Int_t           jetMultiJerUp;
   Int_t           jetMultiJerDown;
   vector<double>   *metEt;
   vector<double>   *metEtJesUp;
   vector<double>   *metEtJesDown;
   vector<double>   *metEtJerUp;
   vector<double>   *metEtJerDown;
   vector<float>   *metPhi;
   Int_t           runNumber;
   Int_t           lumiBlock;
   Int_t           eventNumber;
   ...
   TBranch        *b_jetMulti;   //!
   TBranch        *b_jetMultiJesUp;   //!
   TBranch        *b_jetMultiJesDown;   //!
   TBranch        *b_jetMultiJerUp;   //!
   TBranch        *b_jetMultiJerDown;   //!
   TBranch        *b_metEt;   //!
   TBranch        *b_metEtJesUp;   //!
   TBranch        *b_metEtJesDown;   //!
   TBranch        *b_metEtJerUp;   //!
   TBranch        *b_metEtJerDown;   //!
   TBranch        *b_metPhi;   //!
   TBranch        *b_runNumber;   //!
   TBranch        *b_lumiBlock;   //!
   ...
   //////////////
   ClassDef(Analysis_EE,0);
};

#endif

#ifdef Analysis_EE_cxx
void Analysis_EE::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("jetMultiJesUp", &jetMultiJesUp, &b_jetMultiJesUp);
   fChain->SetBranchAddress("jetMultiJesDown", &jetMultiJesDown, &b_jetMultiJesDown);
   fChain->SetBranchAddress("jetMultiJerUp", &jetMultiJerUp, &b_jetMultiJerUp);
   fChain->SetBranchAddress("jetMultiJerDown", &jetMultiJerDown, &b_jetMultiJerDown);
   fChain->SetBranchAddress("metEt", &metEt, &b_metEt);
   fChain->SetBranchAddress("metEtJesUp", &metEtJesUp, &b_metEtJesUp);
   fChain->SetBranchAddress("metEtJesDown", &metEtJesDown, &b_metEtJesDown);
   fChain->SetBranchAddress("metEtJerUp", &metEtJerUp, &b_metEtJerUp);
   fChain->SetBranchAddress("metEtJerDown", &metEtJerDown, &b_metEtJerDown);
...
void Analysis_EE::GetAllBranches(Long64_t & entry)
{
           ...
           b_jetMultiJesUp->GetEntry(entry);   //!
           b_jetMultiJesDown->GetEntry(entry);   //!
           b_jetMultiJerUp->GetEntry(entry);   //!
           b_jetMultiJerDown->GetEntry(entry);   //!
           b_metEt->GetEntry(entry);   //!
           b_metEtJesUp->GetEntry(entry);   //!
           b_metEtJesDown->GetEntry(entry);   //!
           b_metEtJerUp->GetEntry(entry);   //!
           b_metEtJerDown->GetEntry(entry);   //!
           ...
           b_PUweightPuUp->GetEntry(entry);   //!
           b_PUweightPuDown->GetEntry(entry);   //!

}

#endif // #ifdef Analysis_EE_cxx
