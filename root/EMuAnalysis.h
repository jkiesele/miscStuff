...
// Wed Oct 12 17:45:36 2011 by ROOT version 5.27/06b
// from TTree NTuple/NTuple
// found on file: dcap://dcache-cms-dcap.desy.de//pnfs/desy.de/cms/tier2/store/user/jkiesele/Trees/emu_1fb.root
//////////////////////////////////////////////////////////
...
class EMuAnalysis : public TSelector {
public :
   ...
   Plotter h_vertMulti0, h_vertMulti3, h_vertMulti3a, h_vertMulti4, h_vertMulti5, h_vertMulti6, h_vertMulti7, h_vertMulti8; 
   ...
   TH1D rescaleVert0_h, rescaleVert3_h,rescaleVert4_h,rescaleVert5_h,rescaleVert6_h,rescaleVert7_h,rescaleVert8_h;


   ////////
   ClassDef(EMuAnalysis,0);
};
...
void EMuAnalysis::GetAllBranches(Long64_t & entry)
{
